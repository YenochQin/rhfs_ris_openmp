...
!
      ...
      PRINT *, 'RIS4 DENSNEW: Using OpenMP with ', NUM_THREADS, ' threads'
!
...
!
!$OMP PARALLEL DEFAULT(SHARED) PRIVATE(IC, IR, LCNUM, ITJPOC, IA, IB, TSHELL, ELEMNT1, ELEMNT2, ELEMNT3, ELEMNT4, ELEMNT5, ELEMNT6, ELEMNT7, J, LOC, CONTRI1, CONTRI2, CONTRI3, CONTRI4, CONTRI5, CONTRI6, CONTRI7, NCONTR, TSHELL_S, IA_S, I, LAB)
