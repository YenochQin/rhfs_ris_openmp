...
!
      ...
      WRITE (6, *) 'RHFS: Using OpenMP with ', NUM_THREADS, ' threads'
!
...
!   SERIALIZED: RINT/RINTHF functions are not thread-safe (use global arrays)
!
      DO KT = 1, 2
         DO I = 1, NW
            DO J = 1, NW
...
!
!$OMP PARALLEL DEFAULT(SHARED) PRIVATE(IC, IR, CNUM, LCNUM, ISPARC, ITJPOC, ITJPOR, IDIFF, KT, ELEMNT, ELEMNTGJ, ELEMNTDGJ, IA, IB, TSHELL, K, KK, LOC1, LOC2, CONTR, CONTRGJ, CONTRDGJ)
